                                  ...
                                  <div class="custom-control custom-checkbox mt-4 ml-4">
                                    ...
                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-xs-12 col-sm-8">
                                                            <input type="checkbox" id="costcenter" name="costcenter" class="ace ace-checkbox-2" value="Yes" />
                                                            <label class="lbl" for="ace-settings-navbar"> Cost Center</label>
                                                            <!-- <input id="CostCenterYesNo" name="CostCenterYesNo" type="hidden" value="" /> -->
                                                            &nbsp;<input type="checkbox" id="inventory" name="inventory" class="ace ace-checkbox-2"  value="Yes"/>
