...
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
<button type="submit" name="submittaxbulkbtn" id="submittaxbulkbtn" class="btn btn-success  form-control"><i class="fas fa-upload"></i>&nbsp Upload</button>
</div>
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
</div>
</div>
