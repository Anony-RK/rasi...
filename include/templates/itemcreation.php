...
if($_POST['partnumber'] != '' && $_POST['stocktype'] != '' && $_POST['itemname'] != ''
 && $_POST['unitofmeasure'] != '' && $_POST['hsncode'] != '' &&
$_POST['gstrate'] != '' && $_POST['barcode'] != '' && $_POST['vendor'] != '' 
&& $_POST['type'] != '' && $_POST['noofgmpcs'] != '' && $_POST['reorderlevel'] != '' 
&& $_POST['lowerlevelqty'] != '' && $_POST['isincentive'] != '' && $_POST['isreuse'] != ''
&& $_POST['tablevendorselect'] != '' && $_POST['tableopeningstock'] != '' && $_POST['tableopeningpcs'] != '' 
&& $_POST['tablecostperunit'] != '' && $_POST['tablecostprice'] != '' && $_POST['tablesellingpriceperpc'] != '' && $_POST['tabletotalsellingprice'] != '')
  {  
										...
										<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												<label class="label">Stock Type</label><span class="text-danger">*</span>
													<select tabindex="2" name="stocktype" id="stocktype" class="form-control chosen-select">
														<option value="">Select Stock Type</option>
														<option <?php if(isset($stocktype)) { if($stocktype == "Rental" ) echo 'selected'; }  ?> value="Rental">Rental</option>
														<option  <?php if(isset($stocktype)) { if($stocktype == "Sale" ) echo 'selected'; }  ?> value="Sale">Sale</option>
														<option <?php if(isset($stocktype)) { if($stocktype == "Stock" ) echo 'selected'; }  ?> value="Stock">Stock</option>
														<option  <?php if(isset($stocktype)) { if($stocktype == "Tools" ) echo 'selected'; }  ?> value="Tools">Tools</option>
														<option <?php if(isset($stocktype)) { if($stocktype == "Towel" ) echo 'selected'; }  ?> value="Towel">Towel</option>
													</select>
											...
											<div class="form-group">
												<label class="label">Unit Of Measure</label>
												 ...
												 <select tabindex="4" name="unitofmeasure" id="unitofmeasure" class="form-control comp-field chosen-select">
														...
														$unitselect="SELECT unit FROM units";
											...
											<div class="form-group">
												<label class="label">Vendor</label>
													<select tabindex="10" name="vendor" id="vendor" class="form-control" class="form-control comp-field chosen-select">
														...
														<?php
														$vendorselect="SELECT vendorcode, vendorname FROM vendordetails";
